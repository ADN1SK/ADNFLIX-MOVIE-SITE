      ...
      <div className="relative z-10 max-w-screen-2xl mx-auto w-full px-4 md:px-8 mt-20">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <button className="px-8 py-3.5 rounded-full bg-primary text-white font-bold flex items-center gap-2 shadow-lg shadow-primary/20 hover:scale-105 hover:bg-primary/90 transition-all">
              <Play className="w-5 h-5 fill-current" />
              Watch Trailer
            </button>
            <button className="px-6 py-3.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold flex items-center gap-2 hover:bg-white/20 transition-all">
